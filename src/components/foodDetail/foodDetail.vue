...
.foodDetail .ratings .rateType .type{padding:8px 12px;margin-right:8px;color:rgb(77,85,93);background: rgb(0,160,220,.2);font-size:12px;border-radius:2px;}
.foodDetail .ratings .rateType .type.nolike{color:rgb(77,85,93);background: rgb(77,85,93,.2)}
.foodDetail .ratings .rateType .type.active{background: rgb(0,160,240);color: #fff;}
.foodDetail .ratings .rateType .type.nolike.active{background: rgb(77,85,93)}
...
.foodDetail .rating_list .user{position: absolute;right:0;top:16px;font-size:10px;color:rgb(147,153,159);}
