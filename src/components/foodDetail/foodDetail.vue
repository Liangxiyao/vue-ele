        ...
        <div class="food_cont">
            ...
            <div class="ratings">
                ...
                <div class="ratings_wrap"> 
                    <ul class="">
                        <li v-for="(item,i) in food.ratings" :key="i">
...
<style>
.foodDetail{position: fixed;top:0;bottom:48px;z-index:30;width: 100%;background: #fff;padding-bottom:20px;transition:all .4s;}
...
.foodDetail .ratings .rate_header{padding:16px;}
.foodDetail .ratings .rateType{margin-top:12px;;}
...
.foodDetail .ratings .tip{font-size:12px;color:rgb(147,153,159);line-height: 24px;margin-top:18px;border-top: 1px solid rgba(7,17,27,.1);padding:12px 0;;}
