        ...
        <div class="rating_header">
            ...
            <ul class="score_list">
                ...
                <li class="item">
                    ...
                    <star is="star" :size="36" :score="seller.foodScore"></star>
        ...
        <div class="ratings">
            ...
            <div class="ratings_wrap"> 
                <ul class="rating_list" v-if="ratings && ratings.length>0">
                    <li class="item" v-for="(rating,i) in ratings" :key="i">
...
<style>
.ratings_cont{padding-bottom:55px;;}
...
.rating_header  .star_item{margin-right:6px;}
...
.ratings_cont .ratings .rateType .type{padding:8px 12px;margin-right:8px;background: rgb(0,160,240);color: #fff;font-size:12px;border-radius:2px;}
.ratings_cont .ratings .rateType .type em{font-size:8px;}
.ratings_cont .ratings .rateType .type.like{color:rgb(77,85,93);background: rgb(0,160,220,.2)}
