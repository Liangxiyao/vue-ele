                    ...
                    <li v-for="food in item.foods" :key="food.name" class="food_item" @click="foodDetail(food,$event)">
                        ...
                        <div class="content">
                            ...
                            <div class="price">
                                ...
                                <cart-control :food="food" class="fr" @cart-add="cartAdd"></cart-control>
                            </div>
                        </div>
                    </li>
                </ul>
...
.foods_wrapper .food_list .title{padding-left:14px;height: 26px;line-height: 26px;border-left: 2px solid #d9dde1;font-size:12px;color:rgb(147, 153, 159);background:#f3f5f7;}
.foods_wrapper .item_wrapper{padding:0 18px;} 
...
.foods_wrapper .food_item .content .extra{font-size:10px;color:rgb(147, 153, 159);line-height: 12px;margin-bottom:5px;}
.foods_wrapper .food_item .content .extra .count{margin-right:12px;}
.foods_wrapper .food_item .content .price{font-weight: 700;line-height:24px;margin-bottom: 0;}
.foods_wrapper .food_item .content .now_price{color: rgb(240,20,20);font-size:14px;margin-right: 8px;}
.foods_wrapper .food_item .content .price em{font-weight: normal;font-size:10px;}
